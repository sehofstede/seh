...
<?php /* How to display posts of the Gallery format. The gallery category is the old way. */ ?>
	...
	<?php if ( ( function_exists( 'get_post_format' ) && 'gallery' == get_post_format( $post->ID ) ) || in_category( _x( 'gallery', 'gallery category slug', 'twentyten' ) ) ) : ?>
		<article id="post-<?php the_ID(); ?>" <?php post_class(); ?> itemprop="blogPosts" itemscope itemtype="http://schema.org/BlogPosting">
		    <header>
			    <h2 class="entry-title" itemprop="name"><a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'twentyten' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark" itemprop="url"><?php the_title(); ?></a></h2>
	...
	<?php endif; ?>
            <footer>
			    ...
			    <div class="entry-utility">
				    ...
				    <?php endif; ?>
				    <?php
					    $tags_list = get_the_tag_list( '<span itemprop="keywords">', ', ', '</span>' );
					    if ( $tags_list ):
				    ?>
